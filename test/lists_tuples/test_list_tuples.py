...
@pytest.mark.parametrize("inputs, expected", [([10, 20, 30, 40, 50, 60], [90, 120])])
def test_even_odd_sums(inputs, expected):
    assert even_odd_sums(inputs) == expected


@pytest.mark.parametrize("inputs, expected", [([10, 20, 30, 40, 50, 60], 50)])
...
@pytest.mark.parametrize("inputs, expected", [((10, 20, "a", "30", "bcd"), 60)])
...
@pytest.mark.parametrize("inputs, expected", [([[1, 2], [0, 1], [5, 4]], [1, 3, 9])])
